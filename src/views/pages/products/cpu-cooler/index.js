...
const fields = ['image', 'name', 'rpm', 'noise', 'color', 'radiator', 'price', 'actions'];
...
const CpuCooler = (props) => {
  ...
  const fetchCpuCooler = async () => {
    try {
      let {ok, data} = await props.callApi(RestApi.getCpuCooler);
      if (ok) {
        setCpuCooler(data.cooler);
        setSelectedCPUCooler(data.cooler[0]);
      }
    } catch (e) {
      ...
      <>
        ...
        >
          <CModalHeader closeButton>
            <CModalTitle>{selectedCPUCooler.name}</CModalTitle>
          </CModalHeader>
          <CModalBody>
            <CRow>
              <CCol xs="12" md="12">
                  ...
                  <CCardBody>
                    <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                      ...
                      <CFormGroup row>
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedCPUCooler.name.toString().toUpperCase()}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Fan RPM</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedCPUCooler.rpm}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Noise Level</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p
                            className="form-control-static">{selectedCPUCooler.noise}
                            </p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedCPUCooler.color}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Radiator</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedCPUCooler.radiator}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedCPUCooler.price}</p>
                        </CCol>
                      </CFormGroup>
                    </CForm>
                  </CCardBody>
