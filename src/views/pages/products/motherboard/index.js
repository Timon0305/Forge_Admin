...
const fields = ['image', 'name', 'socket', 'factor', 'max', 'slots', 'color','price', 'actions'];
...
const Motherboard = (props) => {
  ...
  const fetchMotherboard = async () => {
    try {
      let {ok, data} = await props.callApi(RestApi.getMotherboard);
      if (ok) {
        setMotherboard(data.motherboard);
        setSelectedMotherboard(data.motherboard[0]);
      }
    } catch (e) {
  ...
  const onClickView = (cpu) => {
    setSelectedMotherboard(cpu);
    toggleView(true);
  };

  const onClickAdd = (item) => {
    const newComponent = 'motherboard';
      ...
      <>
        ...
        >
          <CModalHeader closeButton>
            <CModalTitle>{selectedMotherboard.name}</CModalTitle>
          </CModalHeader>
          <CModalBody>
            <CRow>
              <CCol xs="12" md="12">
                  ...
                  <CCardBody>
                    <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                      ...
                      <CFormGroup row>
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedMotherboard.name.toString().toUpperCase()}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Socket/CPU</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedMotherboard.socket}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p
                            className="form-control-static">{selectedMotherboard.factor}
                            </p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Memory Max</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedMotherboard.max}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Memory Slots</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedMotherboard.slots}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedMotherboard.color}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedMotherboard.price}</p>
                        </CCol>
                      </CFormGroup>
                    </CForm>
                  </CCardBody>
