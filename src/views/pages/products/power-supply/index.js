...
const fields = ['image', 'name', 'factor', 'efficiency', 'wattage', 'modular', 'color', 'price', 'actions'];
...
const PowerSupply = (props) => {
  ...
  const fetchPowerSupply = async () => {
    try {
      let {ok, data} = await props.callApi(RestApi.getPowerSupply);
      if (ok) {
        setPower(data.power);
        setSelectedPower(data.power[0]);
      }
    } catch (e) {
      ...
      <>
        ...
        >
          <CModalHeader closeButton>
            <CModalTitle>{selectedPower.name}</CModalTitle>
          </CModalHeader>
          <CModalBody>
            <CRow>
              <CCol xs="12" md="12">
                  ...
                  <CCardBody>
                    <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                      ...
                      <CFormGroup row>
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedPower.name.toString().toUpperCase()}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedPower.factor}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Efficiency Rating</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p
                            className="form-control-static">{selectedPower.efficiency}
                            </p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Wattage</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedPower.wattage}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                          <CLabel htmlFor="password-input">Modular</CLabel>
                        </CCol>
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedPower.modular}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedPower.color}</p>
                        </CCol>
                      </CFormGroup>
                      <CFormGroup row>
                        <CCol xs="6" className="text-left text-lg-right">
                        ...
                        <CCol xs="6" >
                          <p className="form-control-static">{selectedPower.price}</p>
                        </CCol>
                      </CFormGroup>
                    </CForm>
                  </CCardBody>
